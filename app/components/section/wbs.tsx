        ...
        <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
          <div className="lg:col-span-2 lg:py-12">
            ...
            <p className="max-w-xl lg:text-lg sm:text-sm">
              ...
              kasus TKP yang dilaporkan. Selanjutnya silahkan diuraikan mengenai
              apa dugaan TKP, siapa yang diduga terlibat, di instansi mana
              terjadi TKP, dan kapan terjadinya TKP tersebut.
            </p>
          </div>
